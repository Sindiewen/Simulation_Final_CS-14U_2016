...
{
	public enum TravelerType { Bicyclist, CityDriver, Hiker, Neutral, VacationDriver };
	...
	public static void Initialize()
	{
		...
		{
			profileDict [TravelerType.Bicyclist] = new TravelerProfile (0f, 1f, -1f, 0.25f, 0.5f);
		}
		if (!profileDict.ContainsKey (TravelerType.CityDriver))
		{
			profileDict [TravelerType.CityDriver] = new TravelerProfile (0f, -1f, 1f, 0f, 0f);
		}
		if (!profileDict.ContainsKey (TravelerType.Hiker))
		{
			profileDict [TravelerType.Hiker] = new TravelerProfile (1f, 0f, -1f, 1f, 0.5f);
		}
		...
		{
			profileDict [TravelerType.VacationDriver] = new TravelerProfile (0f, 0f, 0.75f, 1f, 1f);
		}
	}
