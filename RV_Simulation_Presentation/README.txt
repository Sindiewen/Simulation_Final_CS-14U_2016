...
some simularities, but each take a different route, and each route is unique to them for getting to their destinations.
The most interesting thing though, The florist is doing much better than I expected in the long run despite the lack
of Heartrate. I think that's probably the most interesting actor of the bunch from thoes tests.

	With the variance of Heartrate, BPM, and their Max, idle and current being so different, it really does show that 
actors will have a preference in routes depending on their heartrate. It's really similar to how we as humans tackle
obsticles in our world, especially in San Francisco since it's very hilly with lots of variances.